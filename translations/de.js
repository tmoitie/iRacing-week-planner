export default {
  translation: {
    ...
    'Races for date: {{date, datetime}}': 'Rennen für Datum: {{date, datetime}}',
    ...
    // Dates
    'Every {{every}} starting at {{time, datetime}}': 'Jede {{every}} ab {{time, datetime}}',
    ...
    'Sign in': 'Einloggen',
    'Sign in with Google': 'Einloggen mit Google',
    'Sign in with email': 'Einloggen mit E-Mail',
    'Sign out': 'Ausloggen',
    ...
    'Ignore past weeks': 'Vergangene Wochen ignorieren',
